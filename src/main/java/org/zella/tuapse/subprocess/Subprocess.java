...
public class Subprocess {
    ...
    private static final String WebTorrentDaemonExec = (System.getenv().getOrDefault("WEBTORRENT_DAEMON_EXEC", "dht_web/webtorrent_daemon.js"));
    ...
    public static WebTorrentDaemon webTorrentDaemon() {
        ...
        List<String> cmd = List.of("node", WebTorrentDaemonExec);
